...
<div class="description">
    ...
    <h4 class="name" id="delay"><span class="type-signature"></span>delay<span class="signature">(fn, ms)</span><span class="type-signature"> &rarr; {<a href="function.html">function</a>}</span></h4>
