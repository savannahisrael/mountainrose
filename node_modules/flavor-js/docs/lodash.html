...
<dl class="details">
    ...
    <h4 class="name" id="deepFindBy"><span class="type-signature"></span>deepFindBy<span class="signature">(collection, propName, propValue, childrenPropName<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {*}</span></h4>
...
<span class="param-type"><a href="function.html">function</a></span>
    ...
    <h4 class="name" id="deepOrderBy"><span class="type-signature"></span>deepOrderBy<span class="signature">(collection, propNames, propDirections, childrenPropName<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Array|<a href="object.html">object</a>}</span></h4>
...
<span class="param-type"><a href="object.html">object</a></span>
    ...
    <h4 class="name" id="filterByValues"><span class="type-signature"></span>filterByValues<span class="signature">(collection, key, values)</span><span class="type-signature"> &rarr; {Array}</span></h4>
...
<span class="param-type">Array</span>
    ...
    <h4 class="name" id="isPercentage"><span class="type-signature"></span>isPercentage<span class="signature">(s)</span><span class="type-signature"> &rarr; {<a href="boolean.html">boolean</a>}</span></h4>
...
<span class="param-type"><a href="boolean.html">boolean</a></span>
    ...
    <h4 class="name" id="parsePercentage"><span class="type-signature"></span>parsePercentage<span class="signature">(s)</span><span class="type-signature"> &rarr; {null|<a href="number.html">number</a>}</span></h4>
...
<span class="param-type"><a href="number.html">number</a></span>
    ...
    <h4 class="name" id="pullAllByComparator"><span class="type-signature"></span>pullAllByComparator<span class="signature">(collection, values, comparator, iteratee)</span><span class="type-signature"> &rarr; {<a href="array.html">array</a>}</span></h4>
