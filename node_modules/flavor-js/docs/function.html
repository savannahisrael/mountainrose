...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="extensions_function.js.html">extensions/function.js</a>, <a href="extensions_function.js.html#line3">line 3</a>
    </li></ul></dd>
            ...
            <div class="description">the JS native Function class</div>
    ...
    <h4 class="name" id="isFunction"><span class="type-signature"></span>isFunction<span class="signature">(f)</span><span class="type-signature"> &rarr; {<a href="boolean.html">boolean</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="extensions_function.js.html">extensions/function.js</a>, <a href="extensions_function.js.html#line9">line 9</a>
    </li></ul></dd>
...
<div class="description">
    ...
    <pre class="prettyprint"><code>var f = function(){};
...
console.log(Function.isFunction(null)); // false</code></pre>
...
<span class="param-type"><a href="function.html">function</a></span>
            ...
            <td class="description last">the function to be checked</td>
        </tr>
...
<span class="param-type"><a href="boolean.html">boolean</a></span>
    ...
    <h4 class="name" id="proxy"><span class="type-signature"></span>proxy<span class="signature">(f, scope, &hellip;args)</span><span class="type-signature"> &rarr; {<a href="function.html">function</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="extensions_function.js.html">extensions/function.js</a>, <a href="extensions_function.js.html#line31">line 31</a>
    </li></ul></dd>
...
<div class="description">
    ...
    <pre class="prettyprint"><code>var a = 1;
var b = new Date();
var c = function() {};
...
<span class="param-type"><a href="function.html">function</a></span>
            ...
            <td class="description last">the function to be proxed</td>
        </tr>
...
<span class="param-type"><a href="object.html">object</a></span>
            ...
            <td class="description last">the scope object (will be `this` inside the function)</td>
        </tr>
...
<span class="param-type"><a href="object.html">object</a></span>
            ...
            <td class="description last">pass one or more arguments to override the original handled arguments</td>
        </tr>
